...
int main(int argc, char *argv[])
{
    ...
    Concurrency::array_view<double> av_csr_values(num_nonzero, csr_values);
    ...
    Concurrency::array_view<double> av_csr_res_values(num_nonzero, csr_res_values);
    ...
    Concurrency::array_view<double> av_A_values(num_row*num_col, A_values);
