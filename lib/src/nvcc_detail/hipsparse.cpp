...
hipsparseStatus_t hipsparseScsrmm2(hipsparseHandle_t handle,
    ...
    return hipCudaStatusToHIPStatus(cusparseScsrmm2(handle, hipHIPOperationToCudaOperation(transA),
                                                    hipHIPOperationToCudaOperation(transB),
                                                    m, n, k, nnz, alpha, descrA, csrValA, 
                                                    csrRowPtrA, csrColIndA, B, 
                                                    ldb, beta, C, ldc));
}
...
hipsparseStatus_t hipsparseDcsrmm2(hipsparseHandle_t handle,
    ...
    return hipCudaStatusToHIPStatus(cusparseDcsrmm2(handle, hipHIPOperationToCudaOperation(transA),
                                                    hipHIPOperationToCudaOperation(transB),
                                                    m, n, k, nnz, alpha, descrA, csrValA, 
                                                    csrRowPtrA, csrColIndA, B, 
                                                    ldb, beta, C, ldc));
...
hipsparseStatus_t hipsparseXcsrgemmNnz(hipsparseHandle_t handle,
   ...
   return hipCudaStatusToHIPStatus(cusparseXcsrgemmNnz(handle,
...
hipsparseStatus_t hipsparseXcsrgeamNnz(hipsparseHandle_t handle,
   ...
   return hipCudaStatusToHIPStatus(cusparseXcsrgeamNnz(handle, m, n, descrA,
                                                           nnzA, csrRowPtrA,
